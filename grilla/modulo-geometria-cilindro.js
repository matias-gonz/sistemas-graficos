...
function crearGeometria(){
    ...
    superficie3D=new TuboSenoidal(0.1,0.1,2,6);
...
function TuboSenoidal(a,l,r,h){

    this.getPosicion=function(u,v){
        phi = 2*Math.PI*u;


        var x=(r+a*Math.sin(v*h/l))*Math.cos(phi);
        var y=v*h -3;
        var z=(r+a*Math.sin(v*h/l))*Math.sin(phi);
        return [x,y,z];
    }
    ...
    for (i=0; i < filas; i++) {
        for (j=0; j < columnas; j++) {
            ...
            if(j == 0 && i != 0){
                ...
                console.log(i*(columnas+1) + j)    
            }
            if(j == 0){
                indexBuffer.push(i*(columnas+1) + j);
                console.log(i*(columnas+1) + j)
                indexBuffer.push((i+1)*(columnas+1) + j);
                console.log((i+1)*(columnas+1) + j)
            }
            
            indexBuffer.push(i*(columnas+1) + (j+1));
            console.log(i*(columnas+1) + (j+1))
            indexBuffer.push((i+1)*(columnas+1) + (j+1));
            console.log((i+1)*(columnas+1) + (j+1))
    ...
    for (i=0; i < filas-1; i++) {
        for (j=0; j < columnas-1; j++) {
            ...
            if(j == 0 && i != 0){
                ...
                console.log(i*columnas + j)    
            }
            if(j == 0){
                indexBuffer.push(i*columnas + j);
                console.log(i*columnas + j)
                indexBuffer.push((i+1)*columnas + j);
                console.log((i+1)*columnas + j)
            }
            
            indexBuffer.push(i*columnas + (j+1));
            console.log(i*columnas + (j+1))
            indexBuffer.push((i+1)*columnas + (j+1));
            console.log((i+1)*columnas + (j+1))
